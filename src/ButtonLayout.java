...
public class ButtonLayout {
    ...
    //initializing virtual keyboard
        ...
        JButton buttonE = new Buttons("у", "У", 45, 40, Color.GREEN, KeyEvent.VK_E);
        JButton buttonR = new Buttons("к", "К", 45, 40, Color.CYAN, KeyEvent.VK_R);
        JButton buttonT = new Buttons("е", "Е", 45, 40, Color.CYAN, KeyEvent.VK_T);
        JButton buttonY = new Buttons("н", "Н", 45, 40, Color.MAGENTA, KeyEvent.VK_Y);
        JButton buttonU = new Buttons("г", "Г", 45, 40, Color.MAGENTA, KeyEvent.VK_U);
        JButton buttonI= new Buttons("ш", "Ш", 45, 40, Color.PINK, KeyEvent.VK_I);
        JButton buttonO = new Buttons("щ", "Щ", 45, 40, Color.YELLOW, KeyEvent.VK_O);
        JButton buttonP = new Buttons("з", "З", 45, 40, Color.GREEN, KeyEvent.VK_P);
        ...
        JButton buttonD = new Buttons("в", "В", 45, 40, Color.GREEN, KeyEvent.VK_D);
        JButton buttonF = new Buttons("а", "А", 45, 40, Color.CYAN, KeyEvent.VK_F);
        JButton buttonG = new Buttons("п", "П", 45, 40, Color.CYAN, KeyEvent.VK_G);
        JButton buttonH = new Buttons("р", "Р", 45, 40, Color.MAGENTA, KeyEvent.VK_H);
        JButton buttonJ = new Buttons("о", "О", 45, 40, Color.MAGENTA, KeyEvent.VK_J);
        JButton buttonK = new Buttons("л", "Л", 45, 40, Color.PINK, KeyEvent.VK_K);
        JButton buttonL = new Buttons("д", "Д", 45, 40, Color.YELLOW, KeyEvent.VK_L);
        JButton buttonDotComa = new Buttons("ж", "Ж", 45, 40, Color.GREEN, KeyEvent.VK_COMMA);
